...
Athens_data %>% summarize(sum(Gov_Foreclosure))

Athens_data %>%  top_n(115, Amount) %>% summarize(sum(Gov_Foreclosure, na.rm = ))
...
```{r}
Athens_data %>% filter(Gov_Foreclosure==1) %>% summarize(mean(Amount, na.rm=TRUE))
Athens_data %>% filter(Gov_Foreclosure==1) %>% summarize(median(Amount, na.rm=TRUE))

Athens_data %>% top_n(115, Amount) %>% summarize(mean(Amount, na.rm=TRUE))
Athens_data %>% top_n(115, Amount) %>% summarize(median(Amount, na.rm=TRUE))

Athens_data %>% summarize(mean(Amount, na.rm=TRUE))
Athens_data %>%  summarize(median(Amount, na.rm=TRUE))
